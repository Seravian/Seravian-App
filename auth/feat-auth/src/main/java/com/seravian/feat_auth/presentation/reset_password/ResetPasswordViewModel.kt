...
import com.seravian.validation.ValidateInput
import com.seravian.validation.domain.onError
import com.seravian.validation.domain.onSuccess
    ...
    private fun updatePassword(newPassword: String) {
        viewModelScope.launch {
            val result = authRepository.updatePassword(
                NewPasswordRequest(
                    email = emailStateRepository.emailState.value.email ?: "",
